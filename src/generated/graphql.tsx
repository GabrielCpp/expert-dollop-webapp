...
export type FieldDetailsUnion = BoolFieldConfig | CollapsibleContainerFieldConfig | DecimalFieldConfig | IntFieldConfig | StaticChoiceFieldConfig | StaticNumberFieldConfig | StringFieldConfig;
...
export type FieldValue = BoolFieldValue | DecimalFieldValue | IntFieldValue | ReferenceId | StringFieldValue;
...
export type FindDistributablesQuery = (
  { __typename?: 'Query' }
  & { findDistributables: Array<(
    { __typename?: 'ReportDefinition' }
    & Pick<ReportDefinition, 'id' | 'projectDefinitionId' | 'name'>
  )> }
);
...
export type FindDistributableItemsQuery = (
  { __typename?: 'Query' }
  & { findDistributableItems: Array<(
    { __typename?: 'DistributableItem' }
    & Pick<DistributableItem, 'id' | 'projectId' | 'reportDefinitionId' | 'nodeId' | 'formulaId' | 'distribution_ids' | 'obsolete'>
    & { suppliedItem: (
      { __typename?: 'SuppliedItem' }
      & Pick<SuppliedItem, 'datasheetId' | 'elementDefId' | 'childReferenceId'>
      & { organization: (
        { __typename?: 'Organization' }
        & Pick<Organization, 'id' | 'name' | 'email'>
      ) }
    ), summary: (
      { __typename?: 'ComputedValue' }
...
export type FindProjectReportWithDefinitionQuery = (
  ...
  & { findProjectReport: (
    { __typename?: 'Report' }
    & Pick<Report, 'creationDateUtc' | 'name'>
    & { stages: Array<(
      { __typename?: 'ReportStage' }
      & { columns: Array<(
        { __typename?: 'StageColumn' }
        & Pick<StageColumn, 'label' | 'isVisible' | 'unit'>
      )>, summary: (
        { __typename?: 'ComputedValue' }
        & Pick<ComputedValue, 'label' | 'unit'>
        & { value: (
 ...
 * });
 */
export function useFindDistributablesQuery(baseOptions: Apollo.QueryHookOptions<FindDistributablesQuery, FindDistributablesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FindDistributablesQuery, FindDistributablesQueryVariables>(FindDistributablesDocument, options);
      }
export function useFindDistributablesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FindDistributablesQuery, FindDistributablesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FindDistributablesQuery, FindDistributablesQueryVariables>(FindDistributablesDocument, options);
        }
export type FindDistributablesQueryHookResult = ReturnType<typeof useFindDistributablesQuery>;
export type FindDistributablesLazyQueryHookResult = ReturnType<typeof useFindDistributablesLazyQuery>;
export type FindDistributablesQueryResult = Apollo.QueryResult<FindDistributablesQuery, FindDistributablesQueryVariables>;
 ...
 * });
 */
export function useFindDistributableItemsQuery(baseOptions: Apollo.QueryHookOptions<FindDistributableItemsQuery, FindDistributableItemsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FindDistributableItemsQuery, FindDistributableItemsQueryVariables>(FindDistributableItemsDocument, options);
      }
export function useFindDistributableItemsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FindDistributableItemsQuery, FindDistributableItemsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FindDistributableItemsQuery, FindDistributableItemsQueryVariables>(FindDistributableItemsDocument, options);
        }
export type FindDistributableItemsQueryHookResult = ReturnType<typeof useFindDistributableItemsQuery>;
export type FindDistributableItemsLazyQueryHookResult = ReturnType<typeof useFindDistributableItemsLazyQuery>;
export type FindDistributableItemsQueryResult = Apollo.QueryResult<FindDistributableItemsQuery, FindDistributableItemsQueryVariables>;
